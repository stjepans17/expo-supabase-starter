...
// const progressCircleSize = Math.max(50, SCREEN_WIDTH * 0.15);
...
//       <ProgressCircle size={progressCircleSize} strokeWidth={10} percent={parseInt(percentage)} />
//     </View>
...
//                 <View style={styles.cardContainer}>
//                   {loadingPlan ? (
//                     <View style={styles.planCardLoader}>
//                       <ActivityIndicator size="small" color="#4600DE" />
//                       <Typo style={styles.loadingText}>Loading plan...</Typo>
//                     </View>
...
//                       subtitle="Click to create or activate a plan"
//                       onPress={handlePlanCardPress}
//                     />
//                   )}
//                 </View>
